# LFV with Object Detection {#lane-following-with-object-detection status=beta}
...
## Video of expected results {#demo-lane-following-with-object-detection-expected}

[Video Link (Real) - Lane following with vehicles](https://drive.google.com/open?id=18o9ejgp0wOWVv8RbLE_1Ax0TUQVMIi2S)

## Duckietown setup notes {#demo-lane-following-with-object-detection-duckietown-setup}
...
## Pre-flight checklist {#demo-lane-following-with-object-detection-pre-flight}
...
## Demo instructions {#demo-lane-following-with-object-detection-run}
