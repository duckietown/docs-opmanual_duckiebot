...
**Note:** you can now use `laptop $ dts calibrate_intrinsics ![hostname]` to run intrinsic calibration only. (you will be able to check if ros-picam is running before proceeding with calibration)
...
**Note:** you can now use `laptop $ dts calibrate_extrinsics ![hostname]` to run extrinsic calibration only.
